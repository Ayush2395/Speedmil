...
export default function Register() {
  ...
  //   This function helps to register new user with valid email, if the mail isn't valid u can't enter the site until u verify the mail, which is sent to users mail box
  const handleRegisterNewUser = async (event) => {
    ...
    // register the user with registerNewUser() method, which is defined in the Context file and then navigate to verify page.
    try {
  ...
  //   This function pop-up the google login tab and after successfully signin it will redirect to verify page, where new user have to verify their email first which is sent to their mail id's
